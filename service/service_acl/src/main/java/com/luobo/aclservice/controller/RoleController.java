...
public class RoleController {
    ...
    public Msg index(
        ...
        return Msg.sucess().data("items", pageParam.getRecords()).data("total", pageParam.getTotal());
    }
    ...
    public Msg get(@PathVariable String id) {
        ...
        return Msg.sucess().data("item", role);
    }
    ...
    @PutMapping("update")
    public Msg updateById(@RequestBody Role role) {
