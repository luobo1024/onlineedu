  ...
  <div class="main">
    ...
    <div class="sign-up-container">
      <el-form ref="userForm" :model="params">
        ...
        <el-form-item :rules="[{ required: true, message: '请输入手机号码', trigger: 'blur' },{validator: checkEmail, trigger: 'blur'}]" class="input-prepend restyle no-radius" prop="mobile">
          <div>
...
export default {
  ...
  methods: {
    ...
    submitRegister() {
      registerApi.registeMember(this.params)
        .then(response => {
          this.$message({
            type: 'success',
            message: '注册成功'
