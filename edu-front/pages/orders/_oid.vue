<template>
  <div class="Page Confirm">
    ...
    <form id="flowForm" name="flowForm" method="post" action="">
...
<td colspan="3" class="Title red f18 fb"><p>限时折扣</p></td>
      ...
      <div class="Finish">
        ...
        <input id="usedScore" name="score" value="0" type="hidden" >
        <button id="submitPay" class="fr redb" type="button" @click="toPay()">
          去支 付
        </button>
        <div class="clear"/>
      </div>
