            ...
            <dd class="c-s-dl-li">
              <ul class="clearfix">
                ...
                <li v-for="(item, index) in subjectNestedList" :key="index" :class="{active:oneIndex==index}">
                  <a :title="item.label" href="#" @click="searchOne(item.id,index)">{{ item.label }}</a>
                </li>
              </ul>
            </dd>
          </dl>
            ...
            <dd class="c-s-dl-li">
              <ul class="clearfix">
                <li v-for="(item, index) in subSubjectList" :key="index" :class="{active:twoIndex==index}">
                  <a :title="item.label" href="#" @click="searchTwo(item.id,index)">{{ item.label }}</a>
                </li>
              </ul>
            </dd>
          </dl>
...
export default {
  ...
  methods: {
    initCourseFirst() {
      courseApi.getCourseList(1, 2, this.searchObj)
        .then(response => {
    ...
    gotoPage(page) {
      courseApi.getCourseList(page, 2, this.searchObj)
        .then(response => {
          this.data = response.data.data
        })
    },
